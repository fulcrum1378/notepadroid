...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (filesToDeleteList != null) filesToDelete = filesToDeleteList.toArray();
    ...
    public String getCabString(int size) {
        return getResources().getString((size == 1)
                ? R.string.cab_note_selected : R.string.cab_notes_selected);
    }
    ...
    private void reallyDeleteNotes() {
        ...
        deleteIntent.setAction("ir.mahdiparastesh.notepad.DELETE_NOTES");
        deleteIntent.putExtra("files", filesToDelete2);
        LocalBroadcastManager.getInstance(this).sendBroadcast(deleteIntent);

        Intent listIntent = new Intent();
        listIntent.setAction("ir.mahdiparastesh.notepad.LIST_NOTES");
    ...
    // Loads note from /data/data/ir.mahdiparastesh.notepad.old/files
    ...
    public void printNote(String contentToPrint) {
        ...
        // Apply theme
        String theme = pref.getString("theme", "sans");
        int textSize = -1;

        String fontFamily = null;

        if (theme.contains("sans")) fontFamily = "sans-serif";
        if (theme.contains("serif")) fontFamily = "serif";
        if (theme.contains("monospace")) fontFamily = "monospace";
