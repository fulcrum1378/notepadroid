...
import ir.mahdiparastesh.notepad.activity.MainActivity;
...
public class NoteEditFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if(getActivity() instanceof MainActivity && getActivity().findViewById(R.id.layoutMain)
                .getTag().equals("main-layout-large")) {
    ...
    // Saves notes to /data/data/ir.mahdiparastesh.notepad.old/files
    ...
    public void onDeleteDialogPositiveClick() {
        ...
        if(getActivity().getComponentName().getClassName().equals("ir.mahdiparastesh.notepad.activity.MainActivity")
